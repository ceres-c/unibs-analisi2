...
\begin{proof}(\textbf{Tesi 2})
	...
	\begin{itemize}
		...
		\begin{align*}
			...
			&= \abs{\int_{t_0}^t % TODO qui nella dimostrazione sul libro c'è un <=, anche se non so perché
				L\cdot d_X(x_2,x_1)
				\integrald{\tau}}\\
			&= L \cdot \abs{t-t_0} \cdot d_X(x_2,x_1) \tageq\label{equaz:cau_loc_verif_contraz_fine} % TODO qui nella dimostrazione sul libro c'è un <=, anche se non so perché
		\end{align*}
