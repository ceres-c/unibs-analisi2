...
$$\begin{cases}
	...
	x(t_0)=x_0\\
\end{cases}$$
con $x\in \R, k>0 $ e $ x_0=0$ % TODO questo va messo a fianco del sistema

$\left\{\begin{matrix} x'=k\cdot x\\x(0)=0\end{matrix}\right.$ con $x\in \R, k>0 $ e $ x_0=0$ % TODO regex matta per fare sistemi
