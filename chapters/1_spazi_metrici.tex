...
\begin{proposition}
	...
	Siano $A \subseteq \R^n$ un insieme \textbf{Convesso} (\fullref{def:convesso}) e $f \in \cntclass{1}(A;\R)$. Se tutte le derivate parziali sono limitate in $A$ , allora $f$ è Lipschitziana.
	\begin{proof}
