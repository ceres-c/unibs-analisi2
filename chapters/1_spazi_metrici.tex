	...
	\begin{proof}
		...
		\begin{enumerate}
			\item \textit{Individuazione di una Successione di Cauchy}\\
				...
				\[s = 1 + K + \dotsc + K^{m-n-1} \qquad \text{e} \qquad K \cdot s = K + K^2 + \dotsc + K^{m-n}\]
				...
				\end{equation}
				Essendo $k \in \realintervalclop{0}{1}$, eseguendone l'elevamento a potenza otterrò un numero ancor più piccolo. È dunque certo che
			...
			\item \textit{Dimostrazione unicità punto fisso}\\
				...
				Però
				\begin{itemize}
					\item $1-k > 0$ strettamente positivo perché, per \fullref{def:contrazione} $k \in \realintervalclop{0}{1}$
