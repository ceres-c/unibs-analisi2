...
\begin{example}[Esempi di Metriche]
	...
	\begin{enumerate}
		...
		\item $X=\R,\quad d(x,y)=\abs{y-x}$
			...
			\end{enumerate}
		\item \label{ex:dist_eucl}\index{Metrica!Euclidea}
\index{Distanza!Euclidea}
		...
		\item \label{ex:dist_discr}
			$
				...
				\end{cases}
			$
			\hfill {\footnotesize\textbf{Metrica Discreta}}\index{Metrica!Discreta}
\index{Distanza!Discreta}
			\begin{enumerate}[label=\arabic*.]
				...
				\item $d(x,y) \leq d(x,z) + d(z,y)$ perché $d(x,z) + d(z,y)$ può essere:
					...
					\end{itemize}
			\end{enumerate}
		\item \label{ex:dim_dist_conv_unif}\index{Metrica!Infinito}
\index{Distanza!Infinito}
			$
				\begin{array}{l}
			...
			\end{note}
		\item \label{ex:dist_parigi}\index{Metrica!di Parigi}
\index{Distanza!di Parigi}
			$
				\begin{array}{l}
			...
			\end{enumerate}
		\item \label{ex:dim_dist_quadratica}\index{Metrica!Quadratica}
...
\begin{theorem}[Generale di Weierstrass]
	\index{Teorema!Generale di Weierstrass}
...
\begin{proposition}
	...
	\[f \text{ \textbf{Uniformemente Continua} in } A \implies f \text{ \textbf{Continua} in } A\]
	\begin{proof}
...
\markright{FUNZIONI A VALORI IN $\R^n$}
