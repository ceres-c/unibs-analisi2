...
\begin{example}[Esempi di Metriche]
	...
	\begin{enumerate}
		...
		\item $X=\cntclass{0}(\intervalclose{a}{b},\R)\;a,b\in\R,\;a<b \quad d_\infty(f,g) = \sup\limits_{x\in\intervalclose{a}{b}}\abs{g(x)-f(x)}$ \hfill
			...
			\end{enumerate}
			\begin{note}
				Si sottolinea che queste conclusioni sono valide finché $\intervalclose{a}{b}$ chiuso e limitato, altrimenti non varrebbe più il \fullref{ex:weier_analisi_1} necessario per il punto 1. % TODO Serve un controesempio
			\end{note}
