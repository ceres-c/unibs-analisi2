				...
				\begin{tikzpicture}
					...
					\begin{axis} [
						...
						\pgfplotsinvokeforeach{1,2,...,15} {
							\addplot [smooth, domain=0:1.3] {pow(x, #1)};
			...
			\resizebox{\linewidth}{!}{
				\begin{tikzpicture}
					...
					\begin{axis} [
						...
						\node[circle, fill=black, inner sep=1.4pt] at (\xzero, \xzero) {};
						\draw[dashed] (\xzero, 0) -- (\xzero, \xzero);
					\end{axis}
				\end{tikzpicture}
			}
...
\setcounter{theorem}{0} % Reset counter to fix numbering for equation outside theorem envs
