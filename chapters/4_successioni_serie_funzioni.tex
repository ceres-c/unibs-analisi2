...
\begin{definition}[Successione Puntualmente Convergente]
	\index{Successione!Puntualmente Convergente}
...
\begin{definition}[Successione Uniformemente Convergente]
	\index{Successione!Uniformemente Convergente}
...
\begin{example}
	...
	Nella \fullref{def:dist_quadratica} l'ipotesi di continuità è essenziale, altrimento $d_2$ non sarebbe una distanza.\\
			...
			\begin{subfigure}{.24\textwidth}
				...
				\resizebox{\linewidth}{!}{
					\begin{tikzpicture}
						...
						\addplot [smooth, forget plot, domain=-.21:-.18, samples=100] {sqrt(1 - 5^2*x^2)};
						\addplot [smooth, forget plot, domain=-.18:.18] {sqrt(1 - 5^2*x^2)};
						\addplot [smooth, forget plot, domain=.18:.21, samples=100] {sqrt(1 - 5^2*x^2)};
					\end{axis}
					\end{tikzpicture}
				}
				\caption{$n = 5$}
			...
			\begin{subfigure}{.24\textwidth}
				...
				\resizebox{\linewidth}{!}{
					\begin{tikzpicture}
						...
						\addplot [smooth, forget plot, domain=-.1:.1] {sqrt(1 - 10^2*x^2)};
						\end{axis}
					\end{tikzpicture}
				}
				\caption{$n = 10$}
			...
			\begin{subfigure}{.24\textwidth}
				...
				\resizebox{\linewidth}{!}{
					\begin{tikzpicture}
						...
						\addplot [smooth, forget plot, domain=-.1:.1] {sqrt(1 - 100^2*x^2)};
						\end{axis}
					\end{tikzpicture}
				}
				\caption{$n = 1000$}
