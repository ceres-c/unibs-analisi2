...
\begin{proposition}
	...
	\begin{proof}
		...
		Cioè, differenziando l'$i$\textit{-esimo} elemento (funzione) del vettore $y$, mi "sposto" all'elemento (funzione) $i+1$ di $y$. A questo punto tutti gli elementi di $y$ sono equazioni differenziali del primo ordine.\\
