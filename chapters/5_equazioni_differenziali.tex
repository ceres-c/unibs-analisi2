...
\begin{definition}[Equazione di Volterra]
	...
	La \fullref{eq:volterra} viene denominata \textbf{equazione integrale di Volterra}.
\end{definition}
\begin{note}
...
\begin{example}[Un Problema di Cauchy senza soluzione]
	Sia
	$$\funcdef{f}x[\R]{\qquad\quad\R}[\begin{cases} +1 \quad \text{se}\; x < 0\\ -1 \quad \text{se}\; x \geq 0 \end{cases}]$$
