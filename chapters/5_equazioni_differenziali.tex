...
\definition
Sia $I\subseteq \R $ un intervallo e $n\in N$. Date le $n+1$ funzioni $a_0,a_1,\ldots,a_{n-1}, f:I\to\C$ si dice equazione differenziale ordinaria lineare di ordine $n$, l'equazione differenziale:
