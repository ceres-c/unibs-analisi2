...
\begin{exercise}
	Perchè il \fullref{teo:cau_locale_part_1} è chiamato Teorema di Cauchy \textit{locale}?
	\begin{solution}
...
\begin{example}[Un Problema di Cauchy senza soluzione globale]
	...
	\begin{align*}
		\frac{\integrald{x}}{\integrald{t}} &= x^2(t)\\
		\frac{\integrald{x}}{x^2(t)} &= \integrald{t}\\
		\int_0^t \frac{\integrald{x}}{x^2(\tau)} \integrald{\tau} &= \int_0^t \integrald{\tau}
