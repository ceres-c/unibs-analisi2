...
\begin{theorem}[Teorema della Funzione Implicita - Caso Lineare]
...
\begin{theorem}[Teorema della Funzione Implicita]~
	...
	\end{note} % TODO check vertical spacing here
	Siano:
