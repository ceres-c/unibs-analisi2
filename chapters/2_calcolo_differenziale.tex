...
\begin{definition}[Derivata Parziale e Direzionale]
	...
	Una funzione derivabile parzialmente in ogni direzione è detta \textbf{Derivabile}.
	\begin{note}
...
\begin{example}
	...
	La funzione del seguente grafico non è derivabile in $(0,0)$ lungo $x$ o qualsiasi altra direzione diversa da $y$.
	\begin{figure}[H]
...
\begin{definition}[Differenziale]
	...
	\begin{equation*}
		...
		\end{gathered}
	\end{equation*}
	La matrice $M$ è la \textbf{Derivata Totale} di $f$ calcolata in $x_0$ e si indica con $Df(x_0)$. $Df(x_0)$ è l'\textit{applicazione lineare} che meglio approssima la variazione di $f$ nelle vicinanze di $x_0$.\\
...
\begin{proposition}
	...
	Siano $A \subseteq \R^n$, $x_0 \in \circdot{A}$ e $f:A \mapsto \R^m$
	\[
		f \text{ differenziabile in } x_0
		\implies
		\begin{cases}
			\begin{array}{c}
				f \text{ ammette ogni derivata direzionale in } x_0\\
				e\\
...
\begin{corollary}
	...
	\[
		...
		\begin{cases}
			\begin{array}{c}
				f \text{ ammette ogni derivata parziale in } x_0\\
				e\\
	...
	\end{note}
	\begin{note}
		Il presente corollario offre anche una dimostrazione alternativa della \fullref{prop:unic_deriv_tot}
	\end{note}
	\begin{proof}
