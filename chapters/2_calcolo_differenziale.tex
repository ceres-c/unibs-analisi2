				...
				\begin{tikzpicture}[declare function = {parabola(\x)=\x^2;}]
					\begin{axis} [
						...
						\pgfplotsinvokeforeach{-4.4,-3,-2,-1,0,1,2,3,4.4} {
							\node at (axis cs: #1, {parabola(#1)}) {$1$};
						}
				
						\node at (axis cs: 0, 0) {$0$};
						\node at (axis cs: -.4, 2) {$0$};
						\node at (axis cs: -4, 5) {$0$};
						\node at (axis cs: .6, 8) {$0$};
						\node at (axis cs: 2, 13) {$0$};
						\node at (axis cs: -2.5, 15) {$0$};
						\node at (axis cs: -1.5, 18) {$0$};
						\node at (axis cs: 3.5, 20) {$0$};
						\node at (axis cs: 1.3, 22) {$0$};
						\node at (axis cs: -4, 23) {$0$};
					\end{axis}
				\end{tikzpicture}
			}
		\end{subfigure}
