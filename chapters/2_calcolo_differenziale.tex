...
\begin{proposition}[Unicità della Derivata Totale]
	...
	\end{equation*}
	\begin{proof}
		Sia $t \in \R$ e sia fissato un vettore $e_i$ della base canonica di $\R^n$. Il prodotto \textit{vettore per scalare} $e_i t$ è ancora un vettore in $\R^n$ con l'$i$-esima componente uguale a $t$.
		\begin{align*}
	...
	\begin{proof}
		...
		\begin{enumerate}
			...
			\item \textit{La $T$ è a valori nell'insieme di partenza ($T$ "ben definita")}\\
				...
				\begin{align*}
					\norm{T(x, y) - y_0} &\leq \underbrace{\norm{T(x, y) - T(x, y_0)}}_{\text{(1)}} + \underbrace{\norm{T(x, y_0) - y_0}}_{\text{(2)}}
