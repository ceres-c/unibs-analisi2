...
\begin{center}
\itshape
Le sezioni di questo documento scritte in testo \color{not_explained_section_color}verde \color{black} non son state trattate a lezione e son state riportate dal libro per completezza.
\end{center}
\vfill
\doclicenseThis
