...
Cio\'e prendo una curvae la approssimo con una spezzata, la pi\'u lnga di tutte le poligonali \'e la lunghezza della curva.\\
DISEGNO\\
DISEGNO\\
\definition
...
\begin{proof}
	...
	Entrambe le osservazioni per la continuit\'a di $f$, significa che se $x_0$ \'e un punto in cui la $f>0$ allora per la continuit\'a della funzione anche li vicino si hanno valori maggiori di zero.\\
...
\end{proof}
\observation
Questo lemma \'e concettualmente analogo al Teorema di Fermat nel capitolo delle derivate.
...
\begin{proof}
	...
	Se $v$ \'e un po pi\'u regolare , prendiamo $v=u^(k+1)(x)$. Cio\'e se vogliamo $v\in C^k$ prendiamo.....\\
